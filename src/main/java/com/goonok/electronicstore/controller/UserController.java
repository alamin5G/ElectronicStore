...
public class UserController {
    ...
    public String updateProfile(@Valid @ModelAttribute("userProfileUpdateDto") UserProfileUpdateDto userProfileUpdateDto, BindingResult result, Model model,
        ...
        if (existingUserOpt.isPresent()) {
            ...
            userProfileUpdateDto.setId(existingUser.getId());

            // Check if the email or phone number already exists
            if (userRepository.findByEmail(userProfileUpdateDto.getEmail()).isPresent() && !userProfileUpdateDto.getEmail().equals(existingUser.getEmail())) {
                result.rejectValue("email", "error.user", "This email is already in use");
            }

            if (userRepository.findByPhone(userProfileUpdateDto.getPhone()).isPresent() && !userProfileUpdateDto.getPhone().equals(existingUser.getPhone())) {
